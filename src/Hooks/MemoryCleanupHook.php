...
class MemoryCleanupHook {
	 ...
	 * @param ?int $current_step   Current counter/step, expects index starting from 0. If provided $current_step and $flush_interval, will only flush every $flush_interval steps.
